...
freya::PostProcessPass* greyscale_pass_create(freya::Window* window) {
  ...
  pass_desc.prepare_func = greyscale_pass_on_prepare;
  ...
  pass_desc.shader_context_id = asset_group_push_shader_context(pass_desc.asset_group, generate_greyscale_shader());
