...
/*
    ...
    Overview:
    =========
    Shader program: 'default_pass':
        Get shader desc: default_pass_shader_desc(sg_query_backend());
        Vertex Shader: vs
        Fragment Shader: fs
        Attributes:
            ATTR_default_pass_a_pos => 0
            ATTR_default_pass_a_tex_coords => 1
    Bindings:
        Texture 'u_texture':
...
#error "Please include sokol_gfx.h before default_pass_shader.h"
#endif
...
#endif
#endif
#define ATTR_default_pass_a_pos (0)
#define ATTR_default_pass_a_tex_coords (1)
...
/*
    ...
    void main()
    {
        frag_color = texture(u_texture_u_sampler, o_tex_coords);
    }

*/
static const uint8_t fs_source_glsl430[239] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x34,0x33,0x30,0x0a,0x0a,0x6c,0x61,
    ...
    0x20,0x6f,0x5f,0x74,0x65,0x78,0x5f,0x63,0x6f,0x6f,0x72,0x64,0x73,0x3b,0x0a,0x0a,
    ...
    0x5f,0x75,0x5f,0x73,0x61,0x6d,0x70,0x6c,0x65,0x72,0x2c,0x20,0x6f,0x5f,0x74,0x65,
    0x78,0x5f,0x63,0x6f,0x6f,0x72,0x64,0x73,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
/*
    #version 300 es
...
*/
static const uint8_t fs_source_glsl300es[265] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    ...
    0x70,0x6c,0x65,0x72,0x2c,0x20,0x6f,0x5f,0x74,0x65,0x78,0x5f,0x63,0x6f,0x6f,0x72,
    0x64,0x73,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
static inline const sg_shader_desc* default_pass_shader_desc(sg_backend backend) {
    if (backend == SG_BACKEND_GLCORE) {
        ...
        if (!valid) {
            ...
            desc.label = "default_pass_shader";
        }
        return &desc;
    }
