...
FREYA_API void gfx_context_set_depth_state(GfxContext* gfx, const GfxDepthDesc& depth_desc);
...
FREYA_API void gfx_context_set_stencil_state(GfxContext* gfx, const GfxStencilDesc& stencil_desc);
...
FREYA_API void gfx_context_set_cull_state(GfxContext* gfx, const GfxCullDesc& cull_desc);
...
FREYA_API void gfx_context_set_scissor_rect(GfxContext* gfx, const i32 x, const i32 y, const i32 width, const i32 height);

/// Set the viewport of `gfx` to the given `x`, `y`, `width`, `height`
FREYA_API void gfx_context_set_viewport(GfxContext* gfx, const i32 x, const i32 y, const i32 width, const i32 height);
...
FREYA_API void gfx_context_set_target(GfxContext* gfx, GfxFramebuffer* framebuffer);
...
FREYA_API void gfx_context_clear(GfxContext* gfx, const f32 r, const f32 g, const f32 b, const f32 a);

/// Use/activate all of the resources in `binding_desc` for the next draw call in the given `gfx` context.
FREYA_API void gfx_context_use_bindings(GfxContext* gfx, const GfxBindingDesc& binding_desc);

/// Use/activate the given `pipeline` for the next draw call in the given `gfx` context.
FREYA_API void gfx_context_use_pipeline(GfxContext* gfx, GfxPipeline* pipeline);
...
FREYA_API void gfx_context_draw(GfxContext* gfx, const u32 start_element);
...
FREYA_API void gfx_context_draw_instanced(GfxContext* gfx, const u32 start_element);
...
FREYA_API void gfx_context_draw_multi_indirect(GfxContext* gfx, const u32 offset, const sizei count, const sizei stride = 0);
...
FREYA_API void gfx_context_dispatch(GfxContext* gfx, const u32 work_group_x, const u32 work_group_y, const u32 work_group_z); 
...
FREYA_API void gfx_context_memory_barrier(GfxContext* gfx, const i32 barrier_bits); 

/// Switch to the back buffer or, rather, present the back buffer to the screen. 
/// 
/// @NOTE: This function will be affected by vsync. 
FREYA_API void gfx_context_present(GfxContext* gfx);
...
FREYA_API void gfx_framebuffer_copy(const GfxFramebuffer* src_frame, 
...
FREYA_API GfxFramebufferDesc& gfx_framebuffer_get_desc(GfxFramebuffer* framebuffer);

/// Update the information of `framebuffer` by resetting the clear flags as well as reattaching the 
/// render targets in `desc`.
FREYA_API void gfx_framebuffer_update(GfxFramebuffer* framebuffer, const GfxFramebufferDesc& desc);
...
FREYA_API void gfx_buffer_bind_point(GfxBuffer* buffer, const u32 bind_point);

/// Retrieve the internal `GfxBufferDesc` of `buffer`
FREYA_API GfxBufferDesc& gfx_buffer_get_desc(GfxBuffer* buffer);

/// Update the internal `GfxBufferDesc` of `buff` to the given `desc`.
FREYA_API void gfx_buffer_update(GfxBuffer* buff, const GfxBufferDesc& desc);
...
FREYA_API void gfx_buffer_upload_data(GfxBuffer* buff, const sizei offset, const sizei size, const void* data);
...
FREYA_API void gfx_shader_update(GfxShader* shader, const GfxShaderDesc& desc);
...
FREYA_API void gfx_shader_query(GfxShader* shader, GfxShaderQueryDesc* out_desc);
...
FREYA_API i32 gfx_shader_uniform_lookup(GfxShader* shader, const i8* uniform_name);

/// Upload a uniform array with `count` elements of type `type` with `data` at `location` to `shader`. 
FREYA_API void gfx_shader_upload_uniform_array(GfxShader* shader, const i32 location, const GfxLayoutType type, const void* data, const sizei count);

/// Upload a uniform of type `type` with `data` at `location` to `shader`. 
FREYA_API void gfx_shader_upload_uniform(GfxShader* shader, const i32 location, const GfxLayoutType type, const void* data);
...
FREYA_API const u64 gfx_texture_get_bindless_id(GfxTexture* texture);
...
FREYA_API const bool gfx_texture_reload(GfxTexture* texture, const GfxTextureDesc& desc);
...
FREYA_API GfxPipelineDesc& gfx_pipeline_get_desc(GfxPipeline* pipeline);
