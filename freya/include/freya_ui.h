...
/// Allocate and load a new `UIDocument`, using the given `ui_cfg` as the source of the RML content.
FREYA_API UIDocument* ui_document_load_from_memory(UIContext* ui_ctx, const UIConfig& ui_cfg);
